...
public class Hoplite extends GameCharacter{
	...
	public Hoplite(char affinity, String name, int attack, int vitality, int speed, Attack[] Attacks) {
		super(NATURAL_AFFINITY, "Hoplite", BASE_ATTACK, BASE_VITALITY, BASE_SPEED, ATTACKS);
